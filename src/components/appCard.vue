            ...
            brands: [
                {
                    ...
                    imageHover: "src/assets/img/1b.webp",
                    brand: "Levi's",
                    kind: "Relaxed Fit",
                    price: 29.99,
                    favHeart : true,
                ...
                },
                {
                    ...
                    imageHover: "src/assets/img/2b.webp",
                    brand: "Guess",
                    kind: "Roses Tee",
                    price: 20.99,
                    favHeart : true,
                ...
                },
                {
                    ...
                    imageHover: "src/assets/img/3b.webp",
                    brand: "Come Zucchero Filato",
                    kind: "Voglia di colori pastello",
                    price: 129.99,
                    favHeart : false,
                    badges: [
                    {
                ...
                },
                {
                    ...
                    imageHover: "src/assets/img/4b.webp",
                    brand: "Levi's",
                    kind: "Tee Unisex",
                    price: 14.99,
                    favHeart : false,
                ...
                },
                {
                    ...
                    imageHover: "src/assets/img/5b.webp",
                    brand: "Maya Deluxe",
                    kind: "Stripe Bodice",
                    price: 99.99,
                    favHeart : true,
                ...
                },
                {
                    ...
                    imageHover: "src/assets/img/6b.webp",
                    brand: "Esprit",
                    kind: "Maglione - Black",
                    price: 29.99,
                    favHeart : true,
...
<template>
    <div class="card" v-for="(brands,index) in brands" :key="brands.id">
        ...
        <div class="card-info">
            <p>{{ brands.brand }}</p>
            <h3>{{ brands.kind }}</h3>
            <small class="price">{{ brands.price }} €</small>
        </div>
    </div>
</template>
